...
from booksroom.views import BooksListApiView, BooksRetrieveApiView, BooksCreateApiView, BooksDestroyApiView, \
    BooksUpdateApiView, AuthorListApiView, AuthorRetrieveApiView, AuthorDestroyApiView, AuthorCreateApiView, \
    AuthorUpdateApiView, BookingListApiView, BookingCreateApiView
